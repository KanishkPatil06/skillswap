    ...
    return (
        <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pt-20 text-center sm:px-6 lg:px-8">
            ...
            >
                ...
                <span>SkillSwap 2.0 is live</span>
            </motion.div>
            ...
            >
                <Link href="/signin">
                    <Button size="lg" className="h-12 rounded-full px-8 text-base shadow-[0_0_20px_rgba(124,58,237,0.5)] transition-shadow hover:shadow-[0_0_30px_rgba(124,58,237,0.7)] bg-primary hover:bg-primary/90">
                        Get Started Free
