...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
    ...
    return (
        <AnimatePresence>
            {isOpen && (
                <>
                    {/* Backdrop - Only if acting as a modal */}
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            {/* Card Content */}
                            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-black/80 p-8 shadow-2xl backdrop-blur-xl">
                                {/* Close Button */}
                                <button
                                    onClick={onClose}
                                    className="absolute right-4 top-4 rounded-full p-2 text-muted-foreground transition-colors hover:bg-white/10 hover:text-white"
                                >
                                    <X className="h-4 w-4" />
                                </button>
                                    ...
                                    <div className="space-y-2">
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-xl border border-white/10 bg-black/20 pl-10 py-3 text-sm text-white placeholder:text-muted-foreground shadow-[inner_0_2px_4px_rgba(0,0,0,0.4)] transition-all focus:border-primary/50 focus:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/20"
                                                required
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-xl border border-white/10 bg-black/20 pl-10 pr-10 py-3 text-sm text-white placeholder:text-muted-foreground shadow-[inner_0_2px_4px_rgba(0,0,0,0.4)] transition-all focus:border-primary/50 focus:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/20"
                                                required
                                            />
                                            <button
                                                type="button"
